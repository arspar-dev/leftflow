...
export function VideoShowcaseSection({ dict }: { dict: Dictionary }) {
  ...
  return (
    <section className="py-20 lg:py-32 bg-charcoal-950 text-white overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeIn delay={0.2}>
          <div className="relative overflow-hidden bg-charcoal-900 aspect-video group cursor-pointer" onClick={handlePlay}>
            <video
              ref={videoRef}
